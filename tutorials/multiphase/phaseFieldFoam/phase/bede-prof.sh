...
nsys profile -t nvtx,cuda -o report_gpu_heap --stats=true /nobackup/projects/bddir15/hpc_sdk/Linux_ppc64le/23.1/comm_libs/mpi/bin/mpirun -n $nProcs --bind-to none ./bind.sh $FOAM_USER_APPBIN/$application -parallel > log.$application 2>&1
